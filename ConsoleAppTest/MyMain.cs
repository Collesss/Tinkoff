...
namespace ConsoleAppTest
{
    public class MyMain
    {
        ...
        public MyMain(IConfiguration configuration, IConnection<IContext> connection, ISave<(string fileName, string sheetName)> save, TextWriter streamWriter)
        {
        ...
        public async Task Main(CancellationToken cancellationToken)
        {
            ...
            int days = _configuration.GetValue<int>("days");
